...
Un échantillon de carotte, analysé sur une longueur donnée, présente un volume relativement faible par rapport à celui d’un bloc minier de plusieurs mètres cubes. La teneur de l’échantillon est mesurée sur le matériau prélevé, tandis que la teneur du bloc minier ne peut être mesurée qu’une fois celui-ci exploité. Elle est donc estimée à partir des données disponibles et du modèle spatial retenu.
