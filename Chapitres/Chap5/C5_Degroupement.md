# 5.3 Débiaisement (*debiaising*) et dégroupement (*declustering*)
...
La [Fig. %s](#C5_Gisement.png) présente les teneurs en cuivre d'un gisement
...
est illustré à la [Fig. %s](#C5_Polygone.png)

```{figure} images/C5_Polygone.png
:label: C5_Polygone.png
:align: center 
```
...
La [Fig. %s](#C5_PolygoneDeclus.png) présente 27 données de forages et les
...
```{figure} images/C5_PolygoneDeclus.png
:label: C5_PolygoneDeclus.png
:align: center 
```
...
La [Fig. %s](#C5_PlusProcheDeclus.png) présente les mêmes 27 données de
...
```{figure} images/C5_PlusProcheDeclus.png
:label: C5_PlusProcheDeclus.png
:align: center 
```
...
La [Fig. %s](#C5_CellulesDeclus.png) présente les mêmes 27 données de forage
