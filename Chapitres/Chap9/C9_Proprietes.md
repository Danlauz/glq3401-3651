...
1. **Linéarité des combinaisons estimées**  
   ...
   **Exemple d’application :**  
   ...
   - Les valeurs estimées du bas, obtenues soit directement, soit par différence entre le haut et l’épaisseur, ne coïncideront pas nécessairement.  
   - En revanche, avec un cokrigeage, les deux approches donnent exactement la même estimation du bas.  
   
   Une autre illustration concerne l’**inversion gravimétrique** : en cokrigeant les densités de bloc à partir des anomalies gravimétriques, les densités estimées reproduisent exactement l’anomalie mesurée aux points d’observation.
